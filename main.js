...
function displaycurrent(){
  var cartona=``;
   var x=arrcurrent.length-1;
    ...
    cartona+=`   
    <span class="display-1 fw-bolder bg-degree">${arrcurrent[x].current.temp_c} 
    </span>
 ...
 function displaypredict1(){
  ...
  var cartona=``;
   ...
   <p class="bg-degree">${ arrpredict[1].day.maxtemp_c}</p>
   <p  class="bg-degree">${ arrpredict[1].day.mintemp_c}</p>
  ...
  function displaylocation(){
   var cartona=``;
   cartona+=`
   <span class="display-1 fw-bolder">${item.current.temp_c} 
...
<p>${ arrlocation[1].day.maxtemp_c}</p>
<p>${ arrlocation[1].day.mintemp_c}</p>
...
<p>${ arrlocation[2].day.maxtemp_c}</p>
<p>${ arrlocation[2].day.mintemp_c}</p>
...
function displaypredict2(){
  ...
  var cartona=``;
   ...
   cartona+= ` <img src="https://${arrpredict[1].day.condition.icon}" alt="">
   <p class="bg-degree">${ arrpredict[2].day.maxtemp_c}</p>
   <p class="bg-degree">${ arrpredict[2].day.mintemp_c}</p>
